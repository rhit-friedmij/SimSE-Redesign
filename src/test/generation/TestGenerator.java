...
//		sndg.generate();
		...
		v1.add(ia1);
		SimSEObjectType t1 = new SimSEObjectType(1, "Obsessed");
		t1.addAttribute(name);
		cObjs.addObject(new SimSEObject(v1, t1));
		
		InstantiatedAttribute ia2 = new InstantiatedAttribute(name, "Wednesday");
		Vector<InstantiatedAttribute> v2 = new Vector<>();
		v2.add(ia2);
		SimSEObjectType t2 = new SimSEObjectType(1, "Unobsessed");
		t2.addAttribute(name);
		cObjs.addObject(new SimSEObject(v2, t2));
